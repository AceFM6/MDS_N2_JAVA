  ...
  public Caribou(Long id, String name, Float weight, Float height) {
	...
	public void move() {
		// TODO Auto-generated method stub
  		System.out.println("Your Caribou " + this.getName() + " just move walking" );
	...
	public void eat(Eatable eatable) {
		...
		if(eatable instanceof Vegetable) {
			System.out.println("Your Caribou " + this.getName() + " just eat " + ((Vegetable) eatable).getName());
		} else {
			System.out.println("Your Caribou " + this.getName() + " cannot eat " + ((Animal) eatable).getName());
		}
	}
}
