...
public void move() {
	...
	System.out.println("Your Hyena " + this.getName() + " just move walking" );
}
...
public void eat(Eatable eatable) {
	...
	if(eatable instanceof Animal) {
		System.out.println("Your Hyena " + this.getName() + " just eat " + ((Animal) eatable).getName());
	} else {
		System.out.println("Your Hyena " + this.getName() + " cannot eat " + ((Vegetable) eatable).getName() );
	}	
}
}
