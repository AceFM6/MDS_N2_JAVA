...
public void move() {
	...
	System.out.println("Your Dog " + this.getName() + " just move walking" );
}
...
public void eat(Eatable eatable) {
	...
	if(eatable instanceof Vegetable) {
		System.out.println("Your Dog " + this.getName() + " just eat " + ((Vegetable) eatable).getName());
	} else {
		System.out.println("Your Dog " + this.getName() + " just eat " + ((Animal) eatable).getName());
	}
}
}
